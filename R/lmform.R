...
update_set <- function(data_list,
  ...
  main.parameters$main.random$V_inv <- diag(dim(data_list$y)[1]) - data_list$z%*%(main.parameters$main.random$G - main.parameters$main.random$G%*%main.parameters$main.random$u%*%MASS::ginv(MASS::ginv(t(main.form$random_form)%*%(main.form$random_form))+(t(main.parameters$main.random$u)%*%main.parameters$main.random$G%*%main.parameters$main.random$u))%*%t(main.parameters$main.random$u)%*%main.parameters$main.random$G)%*%t(data_list$z)
  ...
  main.parameters$main.random$sigma_w <- main.parameters$main.random$sigma_w+(1/dim(data_list$z)[1])*c((t(data_list$y%*%main.parameters$main.fixed$alpha - data_list$x%*%main.parameters$main.fixed$beta - data_list$z%*%main.parameters$main.random$u)%*%(data_list$y%*%main.parameters$main.fixed$alpha - data_list$x%*%main.parameters$main.fixed$beta - data_list$z%*%main.parameters$main.random$u) - main.parameters$main.random$sigma_w*sum(diag(main.parameters$main.random$P))))
  main.parameters$main.random$G <- main.parameters$main.random$G+diag(diag((((1/main.parameters$main.random$sigma_w)*(main.parameters$main.random$u)%*%t(main.parameters$main.random$u) - main.parameters$main.random$G%*%t(data_list$z)%*%main.parameters$main.random$P%*%data_list$z%*%main.parameters$main.random$G))))
